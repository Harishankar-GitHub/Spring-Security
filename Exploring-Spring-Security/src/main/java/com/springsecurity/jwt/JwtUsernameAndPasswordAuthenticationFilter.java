...
public class JwtUsernameAndPasswordAuthenticationFilter extends UsernamePasswordAuthenticationFilter
{
    ...
    // From next time, the Client sends only the Token in each requests.        - Once we get the Token after Logging in, we can use it in subsequent requests.
